...
var _GongyitonggaoModel = require('../models/GongyitonggaoModel');

var _GongyitonggaoModel2 = _interopRequireDefault(_GongyitonggaoModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, gongyibiaoti, fengmian, jianjie, gonggaoneirong, fabushijian, clicktime, clicknum, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							gongyibiaoti = req.query.gongyibiaoti;

							if (gongyibiaoti) {

								if (gongyibiaoti.indexOf('%') != -1) {
									where.gongyibiaoti = (0, _defineProperty3.default)({}, _sequelize.Op.like, gongyibiaoti);
								} else {
									where.gongyibiaoti = (0, _defineProperty3.default)({}, _sequelize.Op.eq, gongyibiaoti);
								}
							}
							...
							jianjie = req.query.jianjie;

							if (jianjie) {

								if (jianjie.indexOf('%') != -1) {
									where.jianjie = (0, _defineProperty3.default)({}, _sequelize.Op.like, jianjie);
								} else {
									where.jianjie = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jianjie);
								}
							}
							gonggaoneirong = req.query.gonggaoneirong;

							if (gonggaoneirong) {

								if (gonggaoneirong.indexOf('%') != -1) {
									where.gonggaoneirong = (0, _defineProperty3.default)({}, _sequelize.Op.like, gonggaoneirong);
								} else {
									where.gonggaoneirong = (0, _defineProperty3.default)({}, _sequelize.Op.eq, gonggaoneirong);
								}
							}
							...
							_context.next = 22;
							return _GongyitonggaoModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, gongyibiaoti, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 5;
							return _GongyitonggaoModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _GongyitonggaoModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _GongyitonggaoModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							_context7.prev = 0;
							_context7.next = 3;
							return _GongyitonggaoModel2.default.update({
						...
						case 3:
							_context7.next = 5;
							return _GongyitonggaoModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM gongyitonggao WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Gongyitonggao.js.map