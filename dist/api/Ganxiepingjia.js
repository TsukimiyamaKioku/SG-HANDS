...
var _GanxiepingjiaModel = require('../models/GanxiepingjiaModel');

var _GanxiepingjiaModel2 = _interopRequireDefault(_GanxiepingjiaModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, pingjiabianhao, pingjianeirong, xuniliwu, pingjiashijian, yonghuzhanghao, tableName, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							pingjiabianhao = req.query.pingjiabianhao;

							if (pingjiabianhao) {

								if (pingjiabianhao.indexOf('%') != -1) {
									where.pingjiabianhao = (0, _defineProperty3.default)({}, _sequelize.Op.like, pingjiabianhao);
								} else {
									where.pingjiabianhao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, pingjiabianhao);
								}
							}
							pingjianeirong = req.query.pingjianeirong;

							if (pingjianeirong) {

								if (pingjianeirong.indexOf('%') != -1) {
									where.pingjianeirong = (0, _defineProperty3.default)({}, _sequelize.Op.like, pingjianeirong);
								} else {
									where.pingjianeirong = (0, _defineProperty3.default)({}, _sequelize.Op.eq, pingjianeirong);
								}
							}
							xuniliwu = req.query.xuniliwu;

							if (xuniliwu) {

								if (xuniliwu.indexOf('%') != -1) {
									where.xuniliwu = (0, _defineProperty3.default)({}, _sequelize.Op.like, xuniliwu);
								} else {
									where.xuniliwu = (0, _defineProperty3.default)({}, _sequelize.Op.eq, xuniliwu);
								}
							}
							pingjiashijian = req.query.pingjiashijian;

							if (pingjiashijian) {

								if (pingjiashijian.indexOf('%') != -1) {
									where.pingjiashijian = (0, _defineProperty3.default)({}, _sequelize.Op.like, pingjiashijian);
								} else {
									where.pingjiashijian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, pingjiashijian);
								}
							}
							...
							_context.next = 20;
							return _GanxiepingjiaModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, pingjiabianhao, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _GanxiepingjiaModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _GanxiepingjiaModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _GanxiepingjiaModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _GanxiepingjiaModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM ganxiepingjia WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Ganxiepingjia.js.map