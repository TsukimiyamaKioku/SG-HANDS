...
var _GongyijuanzengModel = require('../models/GongyijuanzengModel');

var _GongyijuanzengModel2 = _interopRequireDefault(_GongyijuanzengModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, juanzengbianhao, juanzengmingcheng, juanzengleixing, juanzengshuliang, juanzengmubiao, juanzengshijian, yonghuzhanghao, yonghuxingming, tableName, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							juanzengbianhao = req.query.juanzengbianhao;

							if (juanzengbianhao) {

								if (juanzengbianhao.indexOf('%') != -1) {
									where.juanzengbianhao = (0, _defineProperty3.default)({}, _sequelize.Op.like, juanzengbianhao);
								} else {
									where.juanzengbianhao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, juanzengbianhao);
								}
							}
							juanzengmingcheng = req.query.juanzengmingcheng;

							if (juanzengmingcheng) {

								if (juanzengmingcheng.indexOf('%') != -1) {
									where.juanzengmingcheng = (0, _defineProperty3.default)({}, _sequelize.Op.like, juanzengmingcheng);
								} else {
									where.juanzengmingcheng = (0, _defineProperty3.default)({}, _sequelize.Op.eq, juanzengmingcheng);
								}
							}
							juanzengleixing = req.query.juanzengleixing;

							if (juanzengleixing) {

								if (juanzengleixing.indexOf('%') != -1) {
									where.juanzengleixing = (0, _defineProperty3.default)({}, _sequelize.Op.like, juanzengleixing);
								} else {
									where.juanzengleixing = (0, _defineProperty3.default)({}, _sequelize.Op.eq, juanzengleixing);
								}
							}
							juanzengshuliang = req.query.juanzengshuliang;

							if (juanzengshuliang) {

								if (juanzengshuliang.indexOf('%') != -1) {
									where.juanzengshuliang = (0, _defineProperty3.default)({}, _sequelize.Op.like, juanzengshuliang);
								} else {
									where.juanzengshuliang = (0, _defineProperty3.default)({}, _sequelize.Op.eq, juanzengshuliang);
								}
							}
							juanzengmubiao = req.query.juanzengmubiao;

							if (juanzengmubiao) {

								if (juanzengmubiao.indexOf('%') != -1) {
									where.juanzengmubiao = (0, _defineProperty3.default)({}, _sequelize.Op.like, juanzengmubiao);
								} else {
									where.juanzengmubiao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, juanzengmubiao);
								}
							}
							juanzengshijian = req.query.juanzengshijian;

							if (juanzengshijian) {

								if (juanzengshijian.indexOf('%') != -1) {
									where.juanzengshijian = (0, _defineProperty3.default)({}, _sequelize.Op.like, juanzengshijian);
								} else {
									where.juanzengshijian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, juanzengshijian);
								}
							}
							...
							_context.next = 26;
							return _GongyijuanzengModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, juanzengmingcheng, juanzengleixing, juanzengmubiao, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _GongyijuanzengModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _GongyijuanzengModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _GongyijuanzengModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _GongyijuanzengModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM gongyijuanzeng WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Gongyijuanzeng.js.map