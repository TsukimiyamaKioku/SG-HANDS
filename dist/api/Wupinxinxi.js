...
var _WupinxinxiModel = require('../models/WupinxinxiModel');

var _WupinxinxiModel2 = _interopRequireDefault(_WupinxinxiModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, wupinbianhao, wupinmingcheng, wupinleixing, wupintupian, jiage, shuliang, guige, dengjiriqi, wupinxiangqing, clicktime, clicknum, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							wupinbianhao = req.query.wupinbianhao;

							if (wupinbianhao) {

								if (wupinbianhao.indexOf('%') != -1) {
									where.wupinbianhao = (0, _defineProperty3.default)({}, _sequelize.Op.like, wupinbianhao);
								} else {
									where.wupinbianhao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, wupinbianhao);
								}
							}
							...
							guige = req.query.guige;

							if (guige) {

								if (guige.indexOf('%') != -1) {
									where.guige = (0, _defineProperty3.default)({}, _sequelize.Op.like, guige);
								} else {
									where.guige = (0, _defineProperty3.default)({}, _sequelize.Op.eq, guige);
								}
							}
							dengjiriqi = req.query.dengjiriqi;

							if (dengjiriqi) {

								if (dengjiriqi.indexOf('%') != -1) {
									where.dengjiriqi = (0, _defineProperty3.default)({}, _sequelize.Op.like, dengjiriqi);
								} else {
									where.dengjiriqi = (0, _defineProperty3.default)({}, _sequelize.Op.eq, dengjiriqi);
								}
							}
							wupinxiangqing = req.query.wupinxiangqing;

							if (wupinxiangqing) {

								if (wupinxiangqing.indexOf('%') != -1) {
									where.wupinxiangqing = (0, _defineProperty3.default)({}, _sequelize.Op.like, wupinxiangqing);
								} else {
									where.wupinxiangqing = (0, _defineProperty3.default)({}, _sequelize.Op.eq, wupinxiangqing);
								}
							}
							...
							clicknum = req.query.clicknum;

							if (clicknum) {

								if (clicknum.indexOf('%') != -1) {
									where.clicknum = (0, _defineProperty3.default)({}, _sequelize.Op.like, clicknum);
								} else {
									where.clicknum = (0, _defineProperty3.default)({}, _sequelize.Op.eq, clicknum);
								}
							}

							_context.next = 30;
							return _WupinxinxiModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, wupinbianhao, wupinmingcheng, wupinleixing, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 5;
							return _WupinxinxiModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _WupinxinxiModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _WupinxinxiModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							_context7.prev = 0;
							_context7.next = 3;
							return _WupinxinxiModel2.default.update({
						...
						case 3:
							_context7.next = 5;
							return _WupinxinxiModel2.default.findOne({ where: { id: req.params.id } });

						case 5:
							recordInfo = _context7.sent;
							_context7.next = 8;
							return recordInfo.increment('clicknum');
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM wupinxinxi WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Wupinxinxi.js.map