...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, userid, refid, tablename, name, picture, type, inteltype, remark, result;
						...
						case 0:
							...
							if (tablename) {
								...
								if (tablename.indexOf('%') != -1) {
									where.tablename = (0, _defineProperty3.default)({}, _sequelize.Op.like, tablename);
								} else {
									where.tablename = (0, _defineProperty3.default)({}, _sequelize.Op.eq, tablename);
								}
							}
							name = req.query.name;
							...
							if (name) {
								...
								if (name.indexOf('%') != -1) {
									...
									where.name = (0, _defineProperty3.default)({}, _sequelize.Op.eq, name);
								}
							}
							...
							if (type) {
								...
								if (type.indexOf('%') != -1) {
									where.type = (0, _defineProperty3.default)({}, _sequelize.Op.like, type);
								} else {
									where.type = (0, _defineProperty3.default)({}, _sequelize.Op.eq, type);
								}
							}
							inteltype = req.query.inteltype;

							if (inteltype) {

								if (inteltype.indexOf('%') != -1) {
									where.inteltype = (0, _defineProperty3.default)({}, _sequelize.Op.like, inteltype);
								} else {
									where.inteltype = (0, _defineProperty3.default)({}, _sequelize.Op.eq, inteltype);
								}
							}
							...
							if (remark) {
								...
								if (remark.indexOf('%') != -1) {
									where.remark = (0, _defineProperty3.default)({}, _sequelize.Op.like, remark);
								} else {
									where.remark = (0, _defineProperty3.default)({}, _sequelize.Op.eq, remark);
								}
							}
							if (_jsonwebtoken2.default.decode(req.headers.token).role != '管理员') {
								where.userid = (0, _defineProperty3.default)({}, _sequelize.Op.eq, req.session.userinfo === undefined ? _jsonwebtoken2.default.decode(req.headers.token).id : req.session.userinfo.id);
							}
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, refid, name, type, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 5;
							return _StoreupModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _StoreupModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _StoreupModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _StoreupModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM storeup WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
...
//# sourceMappingURL=Storeup.js.map