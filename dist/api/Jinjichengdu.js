...
var _JinjichengduModel = require('../models/JinjichengduModel');

var _JinjichengduModel2 = _interopRequireDefault(_JinjichengduModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, jinjibianhao, jinjimingcheng, jinjifengmian, jinjishijian, jinjineirong, fabushijian, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							jinjibianhao = req.query.jinjibianhao;

							if (jinjibianhao) {

								if (jinjibianhao.indexOf('%') != -1) {
									where.jinjibianhao = (0, _defineProperty3.default)({}, _sequelize.Op.like, jinjibianhao);
								} else {
									where.jinjibianhao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jinjibianhao);
								}
							}
							jinjimingcheng = req.query.jinjimingcheng;

							if (jinjimingcheng) {

								if (jinjimingcheng.indexOf('%') != -1) {
									where.jinjimingcheng = (0, _defineProperty3.default)({}, _sequelize.Op.like, jinjimingcheng);
								} else {
									where.jinjimingcheng = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jinjimingcheng);
								}
							}
							jinjifengmian = req.query.jinjifengmian;

							if (jinjifengmian) {

								if (jinjifengmian.indexOf('%') != -1) {
									where.jinjifengmian = (0, _defineProperty3.default)({}, _sequelize.Op.like, jinjifengmian);
								} else {
									where.jinjifengmian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jinjifengmian);
								}
							}
							jinjishijian = req.query.jinjishijian;

							if (jinjishijian) {

								if (jinjishijian.indexOf('%') != -1) {
									where.jinjishijian = (0, _defineProperty3.default)({}, _sequelize.Op.like, jinjishijian);
								} else {
									where.jinjishijian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jinjishijian);
								}
							}
							jinjineirong = req.query.jinjineirong;

							if (jinjineirong) {

								if (jinjineirong.indexOf('%') != -1) {
									where.jinjineirong = (0, _defineProperty3.default)({}, _sequelize.Op.like, jinjineirong);
								} else {
									where.jinjineirong = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jinjineirong);
								}
							}
							...
							_context.next = 20;
							return _JinjichengduModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, jinjibianhao, jinjimingcheng, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _JinjichengduModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _JinjichengduModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _JinjichengduModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _JinjichengduModel2.default.findOne({ where: { id: req.params.id } });
					...
					switch (_context9.prev = _context9.next) {
						case 0:
							...
							if (req.params.type == 1) {
								if (req.query.remindstart) sql = "SELECT COUNT(*) AS count FROM jinjichengdu WHERE " + req.params.columnName + " >= '" + req.query.remindstart + "'";
								if (req.query.remindend) sql = "SELECT COUNT(*) AS count FROM jinjichengdu WHERE " + req.params.columnName + " <= '" + req.query.remindend + "'";

								if (req.query.remindstart && req.query.remindend) {
									sql = "SELECT COUNT(*) AS count FROM jinjichengdu WHERE " + req.params.columnName + " >= '" + req.query.remindstart + "' AND " + req.params.columnName + " <= '" + req.query.remindend + "'";
								}
							}
							...
							if (req.params.type == 2) {
								if (req.query.remindstart) {
									...
									sql = "SELECT COUNT(*) AS count FROM jinjichengdu WHERE " + req.params.columnName + " >= '" + remindStart + "'";
								}
								if (req.query.remindend) {
									remindEnd = _util2.default.getDateTimeFormat(req.query.remindend, "yyyy-MM-dd");

									sql = "SELECT COUNT(*) AS count FROM jinjichengdu WHERE " + req.params.columnName + " <= '" + remindEnd + "'";
								}
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM jinjichengdu WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						case 0:
							...
							// let tableName = "jinjichengdu"

							where = " WHERE 1 = 1 ";

							sql = "SELECT COUNT(*) AS total, " + columnName + " FROM jinjichengdu " + where + " GROUP BY " + columnName + " LIMIT 10";
				...
				while (1) {
					switch (_context11.prev = _context11.next) {
						case 0:
							...
							if ("jinjichengdu" == "orders") {
								where += " AND status IN ('已支付', '已发货', '已完成') ";
							}

							sql = "SELECT " + xColumnName + ", SUM(" + yColumnName + ") AS total FROM jinjichengdu " + where + " GROUP BY " + xColumnName + " DESC LIMIT 10";
...
//# sourceMappingURL=Jinjichengdu.js.map