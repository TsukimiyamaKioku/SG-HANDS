...
var _WupinleixingModel = require('../models/WupinleixingModel');

var _WupinleixingModel2 = _interopRequireDefault(_WupinleixingModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, wupinleixing, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							_context.next = 10;
							return _WupinleixingModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _WupinleixingModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _WupinleixingModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _WupinleixingModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _WupinleixingModel2.default.findOne({ where: { id: req.params.id } });
					...
					switch (_context9.prev = _context9.next) {
						case 0:
							...
							if (req.params.type == 1) {
								if (req.query.remindstart) sql = "SELECT COUNT(*) AS count FROM wupinleixing WHERE " + req.params.columnName + " >= '" + req.query.remindstart + "'";
								if (req.query.remindend) sql = "SELECT COUNT(*) AS count FROM wupinleixing WHERE " + req.params.columnName + " <= '" + req.query.remindend + "'";

								if (req.query.remindstart && req.query.remindend) {
									sql = "SELECT COUNT(*) AS count FROM wupinleixing WHERE " + req.params.columnName + " >= '" + req.query.remindstart + "' AND " + req.params.columnName + " <= '" + req.query.remindend + "'";
								}
							}
							...
							if (req.params.type == 2) {
								if (req.query.remindstart) {
									...
									sql = "SELECT COUNT(*) AS count FROM wupinleixing WHERE " + req.params.columnName + " >= '" + remindStart + "'";
								}
								if (req.query.remindend) {
									remindEnd = _util2.default.getDateTimeFormat(req.query.remindend, "yyyy-MM-dd");

									sql = "SELECT COUNT(*) AS count FROM wupinleixing WHERE " + req.params.columnName + " <= '" + remindEnd + "'";
								}
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM wupinleixing WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						case 0:
							...
							// let tableName = "wupinleixing"

							where = " WHERE 1 = 1 ";

							sql = "SELECT COUNT(*) AS total, " + columnName + " FROM wupinleixing " + where + " GROUP BY " + columnName + " LIMIT 10";
				...
				while (1) {
					switch (_context11.prev = _context11.next) {
						case 0:
							...
							if ("wupinleixing" == "orders") {
								where += " AND status IN ('已支付', '已发货', '已完成') ";
							}

							sql = "SELECT " + xColumnName + ", SUM(" + yColumnName + ") AS total FROM wupinleixing " + where + " GROUP BY " + xColumnName + " DESC LIMIT 10";
...
//# sourceMappingURL=Wupinleixing.js.map