...
var _JiaoyixinxiModel = require('../models/JiaoyixinxiModel');

var _JiaoyixinxiModel2 = _interopRequireDefault(_JiaoyixinxiModel);
...
exports.default = function (_ref) {
	...
	api.get('/page', function () {
		var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
			var page, limit, sort, order, where, jiaoyibianhao, wupinmingcheng, wupinleixing, wupintupian, jiage, shuliang, zongjiage, jiaoyishijian, yonghuzhanghao, yonghuxingming, ispay, tableName, result;
				...
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							...
							where = {};
							jiaoyibianhao = req.query.jiaoyibianhao;

							if (jiaoyibianhao) {

								if (jiaoyibianhao.indexOf('%') != -1) {
									where.jiaoyibianhao = (0, _defineProperty3.default)({}, _sequelize.Op.like, jiaoyibianhao);
								} else {
									where.jiaoyibianhao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jiaoyibianhao);
								}
							}
							wupinmingcheng = req.query.wupinmingcheng;

							if (wupinmingcheng) {

								if (wupinmingcheng.indexOf('%') != -1) {
									where.wupinmingcheng = (0, _defineProperty3.default)({}, _sequelize.Op.like, wupinmingcheng);
								} else {
									where.wupinmingcheng = (0, _defineProperty3.default)({}, _sequelize.Op.eq, wupinmingcheng);
								}
							}
							wupinleixing = req.query.wupinleixing;

							if (wupinleixing) {

								if (wupinleixing.indexOf('%') != -1) {
									where.wupinleixing = (0, _defineProperty3.default)({}, _sequelize.Op.like, wupinleixing);
								} else {
									where.wupinleixing = (0, _defineProperty3.default)({}, _sequelize.Op.eq, wupinleixing);
								}
							}
							wupintupian = req.query.wupintupian;

							if (wupintupian) {

								if (wupintupian.indexOf('%') != -1) {
									where.wupintupian = (0, _defineProperty3.default)({}, _sequelize.Op.like, wupintupian);
								} else {
									where.wupintupian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, wupintupian);
								}
							}
							jiage = req.query.jiage;

							if (jiage) {

								if (jiage.indexOf('%') != -1) {
									where.jiage = (0, _defineProperty3.default)({}, _sequelize.Op.like, jiage);
								} else {
									where.jiage = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jiage);
								}
							}
							shuliang = req.query.shuliang;

							if (shuliang) {

								if (shuliang.indexOf('%') != -1) {
									where.shuliang = (0, _defineProperty3.default)({}, _sequelize.Op.like, shuliang);
								} else {
									where.shuliang = (0, _defineProperty3.default)({}, _sequelize.Op.eq, shuliang);
								}
							}
							zongjiage = req.query.zongjiage;

							if (zongjiage) {

								if (zongjiage.indexOf('%') != -1) {
									where.zongjiage = (0, _defineProperty3.default)({}, _sequelize.Op.like, zongjiage);
								} else {
									where.zongjiage = (0, _defineProperty3.default)({}, _sequelize.Op.eq, zongjiage);
								}
							}
							jiaoyishijian = req.query.jiaoyishijian;

							if (jiaoyishijian) {

								if (jiaoyishijian.indexOf('%') != -1) {
									where.jiaoyishijian = (0, _defineProperty3.default)({}, _sequelize.Op.like, jiaoyishijian);
								} else {
									where.jiaoyishijian = (0, _defineProperty3.default)({}, _sequelize.Op.eq, jiaoyishijian);
								}
							}
							yonghuzhanghao = req.query.yonghuzhanghao;

							if (yonghuzhanghao) {

								if (yonghuzhanghao.indexOf('%') != -1) {
									where.yonghuzhanghao = (0, _defineProperty3.default)({}, _sequelize.Op.like, yonghuzhanghao);
								} else {
									where.yonghuzhanghao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, yonghuzhanghao);
								}
							}
							yonghuxingming = req.query.yonghuxingming;

							if (yonghuxingming) {

								if (yonghuxingming.indexOf('%') != -1) {
									where.yonghuxingming = (0, _defineProperty3.default)({}, _sequelize.Op.like, yonghuxingming);
								} else {
									where.yonghuxingming = (0, _defineProperty3.default)({}, _sequelize.Op.eq, yonghuxingming);
								}
							}
							ispay = req.query.ispay;

							if (ispay) {

								if (ispay.indexOf('%') != -1) {
									where.ispay = (0, _defineProperty3.default)({}, _sequelize.Op.like, ispay);
								} else {
									where.ispay = (0, _defineProperty3.default)({}, _sequelize.Op.eq, ispay);
								}
							}
							...
							if (tableName == 'yonghu') {
								where.yonghuzhanghao = (0, _defineProperty3.default)({}, _sequelize.Op.eq, req.session.userinfo === undefined ? _jsonwebtoken2.default.decode(req.headers.token).username : req.session.userinfo.yonghuzhanghao);
							...
							_context.next = 32;
							return _JiaoyixinxiModel2.default.findAndCountAll({
								order: [[sort, order]],
								where: where,
								offset: (page - 1) * limit,
								limit: limit
	...
	api.get('/list', function () {
		var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
			var page, limit, sort, order, where, wupinmingcheng, result;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.next = 4;
							return _JiaoyixinxiModel2.default.create(req.body);
				...
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							_context5.prev = 0;
							_context5.next = 3;
							return _JiaoyixinxiModel2.default.update(req.body, {
								where: {
									id: req.body.id || 0
								}
							});
				...
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.prev = 0;
							_context6.next = 3;
							return _JiaoyixinxiModel2.default.destroy({
								where: {
				...
				while (1) {
					switch (_context7.prev = _context7.next) {
						case 0:
							...
							_context7.t1 = res;
							_context7.next = 5;
							return _JiaoyixinxiModel2.default.findOne({ where: { id: req.params.id } });
						...
						case 0:
							...
							if (req.params.type == 2) {
								...
								if (req.query.remindstart && req.query.remindend) {
									...
									sql = "SELECT COUNT(*) AS count FROM jiaoyixinxi WHERE " + req.params.columnName + " >= '" + _remindStart + "' AND " + req.params.columnName + " <= '" + _remindEnd + "'";
								}
							}
				...
				while (1) {
					switch (_context10.prev = _context10.next) {
						case 0:
							...
							if (tableName == 'yonghu') {
								where += " AND yonghuzhanghao = '" + _jsonwebtoken2.default.decode(req.headers.token).username + "' ";
							}
...
//# sourceMappingURL=Jiaoyixinxi.js.map