...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.3)"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="User name" prop="username">
            <el-input v-model="ruleForm.username" 
                placeholder="User name" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="Password" prop="password">
            <el-input v-model="ruleForm.password" 
                placeholder="Password" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="Role" prop="role">
            <el-input v-model="ruleForm.role" 
                placeholder="Role" clearable ></el-input>
          </el-form-item>
  ...
  export default {
    data() {
      return {
        ...
        rules: {
          username: [
            { required: true, message: 'User name cannot be blank', trigger: 'blur' },
          ],
          password: [
