...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.3)"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="公益标题" prop="gongyibiaoti">
            <el-input v-model="ruleForm.gongyibiaoti" 
                placeholder="公益标题" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="封面" v-if="type!='cross' || (type=='cross' && !ro.fengmian)" prop="fengmian">
            <file-upload
            tip="点击上传封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' class="upload" v-else label="封面" prop="fengmian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="简介" prop="jianjie">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="简介"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="公告内容" prop="gonggaoneirong">
            <editor 
