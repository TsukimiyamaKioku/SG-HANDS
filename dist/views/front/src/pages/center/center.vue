<template>
<div class="center-preview" :style='{"width":"90%","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.6)"}'>
	<div class="title" :style='{"width":"100%","margin":"10px 0","fontSize":"20px","lineHeight":"54px","color":"#333","textAlign":"center"}'>{{ title }}</div>

    <el-tabs tab-position="left" :style='{"width":"100%","flexWrap":"wrap","background":"none","justifyContent":"space-between","display":"flex"}' @tab-click="handleClick">
        ...
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="120px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='yonghu'" label="头像">
            <el-upload
              ...
              <img :style='{"border":"1px solid #eee","cursor":"pointer","color":"#333","borderRadius":"6px","textAlign":"center","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='yonghu'" label="手机号码" prop="shoujihaoma">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='yonghu'" label="身份证号" prop="shenfenzhenghao">
            <el-input v-model="sessionForm.shenfenzhenghao" placeholder="身份证号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"0","margin":"0"}'>
            <el-button :style='{"border":"1px solid #fe9dc5","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#f8e0e0","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit('sessionForm')">更新信息</el-button>
            <el-button :style='{"border":"1px solid #adadad","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#333","borderRadius":"4px","background":"#eeeeee","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="danger" @click="logout">退出登录</el-button>
          </el-form-item>
        </el-form>
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .center-preview .el-tabs /deep/ .el-tabs__header {
	...
	margin: 0;
	background: url(http://codegen.caihongy.cn/20230105/3142383f9fe4461cbba182e1e14cc244.png) no-repeat right bottom / auto 100%,url(http://codegen.caihongy.cn/20230105/8c5939a42d174cd59e7b33368ec5ad2c.png) no-repeat 0px bottom / auto 100%,#fff;
	display: flex;
	width: 100%;
	border-color: #f8dede;
