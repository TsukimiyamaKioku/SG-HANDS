<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="捐赠类型" prop="juanzengleixing">
					<el-input v-model="ruleForm.juanzengleixing" placeholder="捐赠类型" clearable  :readonly="ro.juanzengleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="捐赠类型" prop="juanzengleixing">
					<el-input v-model="ruleForm.juanzengleixing" placeholder="捐赠类型" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `juanzengleixing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.juanzengleixingCrossAddOrUpdateFlag = false;
						 this.parent.search();
