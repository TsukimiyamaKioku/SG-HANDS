	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="物品类型" prop="wupinleixing">
					<el-select :disabled="ro.wupinleixing" v-model="ruleForm.wupinleixing" placeholder="请选择物品类型" >
						<el-option
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="物品类型" prop="wupinleixing">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="登记日期" prop="dengjiriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.dengjiriqi" label="登记日期" prop="dengjiriqi">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.wupinxiangqing = this.ruleForm.wupinxiangqing.replace(reg,'../../../nodejsv6o62/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
